...
function TweetBox() {
  ...
  const [formData, setFormData] = useState({'user':userData.id,'tweet': '','image': null,});
  ...
  const onChange = e => (setFormData(prevFormData =>({ ...prevFormData, [e.target.name]: e.target.value })));
